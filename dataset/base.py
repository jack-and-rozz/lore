...
class PartitionedDatasetBase(object):
  ...
  def __init__(self, vocab, config, filename, max_rows, 
               maxlen, minlen, batch_size, do_shuffle=False):
    '''
    Args:
  ...
  def __next__(self, batch_size=None, do_shuffle=None):
    ...
    batch = self.create_batch(self.data[self.cnt:self.cnt+batch_size])
    self.cnt += batch_size
    return batch
    ...
    #   batch = self.create_batch(sliced_data)
    #   yield batch
  ...
  @staticmethod
  def create_text_batch(*args, **kwargs):
    raise NotImplementedError
  ...
  @classmethod
  def evaluate(self_cls, *args, **kwargs):
    raise NotImplementedError

  @classmethod
  def print_example(self_cls, *args, **kwargs):
    raise NotImplementedError

  @classmethod
  def decorate_output(self_cls, output, *args, **kwargs):
    return output
